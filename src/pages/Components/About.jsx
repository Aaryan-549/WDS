...
const AboutSection = () => {
  return (
    ...
    <div style={{ zIndex: -1 }} className=" nulshock relative h-screen w-full bg-stone-950 ">
      ...
      <div className =' top-11 nulshock text-8xl text-white font-bold opacity-40 translate-x-60 '>
       01</div>
      <p className=" px-60 py-10 nulshock text-lg text-gray-900 font-medium ">
      ...
      <p className=" px-60 py-10 nulshock text-lg text-gray-900">
      ...
      <div className="grid grid-cols-6 grid-rows-1 gap-x-4 mt-4">
          <div className="col-start-4  row-start-1  col-span-2">
            <Box />
          </div>
      ...
      <img style={{ zIndex: -2 }} src={AboutImage} alt="about" className=" absolute top-0 left-0 h-full w-full object-cover" />
    </div>
    </div>
  );
};
